    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-4xl font-bold mb-2">⭐ Favorites</h2>
            <p className="text-gray-400">You have {notes.length} favorite{notes.length !== 1 ? 's' : ''}</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-gray-800 rounded-xl p-12 border border-gray-700 text-center">
            ...
            <p className="text-gray-400 mb-6">Star your important notes to find them here!</p>
            <button
              onClick={() => navigate('/notes')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {notes.map((note) => (
              <div
                key={note.id}
                className="bg-gray-800 rounded-xl border-2 transition-all hover:scale-105 overflow-hidden"
